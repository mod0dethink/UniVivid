    ...
    <section>
      ...
      <div className="pt-16">
        <div className="flex items-center space-x-4">
          <img
            src={ProImg}
            className=" size-20 rounded-full ml-[5vw]"
            alt="Profile"
          />
        ...
        <div>
          <div className="mt-5 ">
            ...
            <div className=" border-main-middle border-2 border-dashed h-[30vw] w-[90vw] ml-[4vw]">
              {/* 画像 */}
              <img
                src="/static/media/note2.c64b1c5a9cc38667d261.png"
                className="w-[40vw] h-[20vw] ml-[25vw] mt-[5vw]"
                alt="ノートの画像"
              />
            </div>
          </div>
          ...
          <div className=" w-[90vw] ml-[10%] font-bold ml-[5vw]">
            ...
            <div className="flex my-2" name="lname">
              ...
              <p className="my-auto ml-3">
                ArduinoでRaspberry Piを用い、IoTに触れる。
              </p>
            </div>
            <div className="flex my-2" name="lname">
