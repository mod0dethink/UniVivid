    ...
    <div>
      ...
      <section className="gradient-background w-dvw h-dvh flex justify-around items-center text-center">
        <div className="space-y-10 h-full">
          <div className="flex h-2/5 items-end text-center ">
            <p className="text-[35px] font-bold ml-auto mr-5">
              UniVividを始める
            </p>
            <img src={images.pen} className="size-48 -mr-44" alt="pen" />
          </div>
          <div className="space-y-[20px]">
            ...
            >
              ...
              <div className="scale-hover-x flex">
        ...
        <div className="bg-main h-dvh w-dvw flex font-bold">
          <div className="w-1/2 content-center">
            <img
              ...
              alt="web"
              title="web"
              className="rounded-2xl w-5/6 mx-auto"
            />
          </div>
          <div className="w-1/2 text-white content-center text-center">
            ...
            <div className="text-sm">
              ...
              <p>
                <span className="text-xl text-[#FFD2AA]">
                  “本当に学びたいモノ”
                </span>
                を見つけよう！
              </p>
        ...
        <div className="h-dvh w-dvw font-bold flex items-center text-center">
          <div className="w-1/2 h-full px-20">
            <div className="h-3/5 content-end">
              <img src={images.WebImage2} alt="" className="w-96 mx-auto" />
            </div>
            <div className="mt-10">
              <p className="text-main text-5xl mb-5">目的</p>
              <p>
                本サイトは、大学が無料で開講されている公開講義を運用して、どの大学・どの学部が自分の学びたいものにマッチしているかを利用者が見出すことをサポートします。
              </p>
            </div>
          </div>
          <div className="w-1/2 h-full px-20">
            <div className="h-3/5 content-end">
              <img src={images.WebImage3} alt="" className="w-96 mx-auto" />
            </div>
            <div className="mt-10">
