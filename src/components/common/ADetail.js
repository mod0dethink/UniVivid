...
const ADetail = (value) => {
  return (
    <div>
      <div className="absolute top-[100px] left-[940px]">{value.date}</div>
      <div
        className="absolute top-[100px] left-[360px] flex justify-center items-center w-[370px] h-[60px] text-[36px] font-bold rounded-[10px] text-white"
